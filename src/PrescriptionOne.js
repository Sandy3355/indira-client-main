  ...
  const handleSubmit = async () => {
    try {
      ...
      if (response.status === 201) {
        ...
        alert("Error submitting prescription. Please check the console for details.");
      }
      // alert("Prescription submitted successfully!");
      setPrescriptionData({
        patientDetails: {
              ...
              <tr key={index}>
                ...
                <td className="hms-table-td">
                  <select
                    ...
                    value={medicine.dose}
                    onChange={(e) =>
                      handleMedicineChange(index, "dose", { value: e.target.value })
                    }
                  >
                ...
                <td className="hms-table-td">
                  <select
                    ...
                    value={medicine.when}
                    onChange={(e) =>
                      handleMedicineChange(index, "when", { value: e.target.value })
                    }
                  >
                ...
                <td className="hms-table-td">
                  <select
                    ...
                    onChange={(e) =>
                      handleMedicineChange(index, "duration", { value: e.target.value })
                    }
                  >
                ...
                <td className="hms-table-td">
                  <select
                    ...
                    onChange={(e) =>
                      handleMedicineChange(index, "frequency", { value: e.target.value })
                    }
                  >
                ...
                <td className="hms-table-td">
                  <input
                    ...
                    onChange={(e) =>
                      handleMedicineChange(index, "notes", { value: e.target.value })
                    }
                  />
                </td>
                <td className="hms-table-td">
